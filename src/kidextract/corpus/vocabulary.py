...
VARIANTS: dict[str, dict[str, tuple[str, ...]]] = {
    ...
    "fr": {
        ...
        "risk": ("Indicateur de risque", "Indicateur synthétique de risque", "Profil de risque et de rendement", "Profil de risque"),
        "costs": ("Que va me coûter cet investissement ?", "Frais", "Coûts et frais", "Ce que cet investissement vous coûtera"),
        "holding": ("Combien de temps dois-je le conserver ?", "Période de détention recommandée", "Horizon d'investissement"),
        "practical": ("Informations pratiques", "Autres informations", "Informations complémentaires"),
        "manufacturer": ("Initiateur", "Société de gestion", "Gestionnaire du fonds", "Promoteur"),
        "isin": ("ISIN", "Code ISIN", "Identifiant", "Code valeur"),
        "currency": ("Devise", "Devise du fonds", "Devise de la part", "Devise de référence"),
        "benchmark": ("Indice de référence", "Reference", "Benchmark", "Indice"),
        "domicile": ("Domiciliation", "Pays de domiciliation", "Domicile du fonds", "Enregistré en"),
        "rhp": ("Période de détention recommandée", "Durée de détention recommandée", "Durée minimale recommandée"),
        "ongoing": ("Frais courants", "Coûts récurrents", "Frais de gestion courants", "Charges courantes"),
        "entry": ("Coûts d'entrée", "Frais d'entrée", "Commission de souscription", "Droit d'entrée"),
        "exit": ("Coûts de sortie", "Frais de sortie", "Commission de rachat"),
        "transaction": ("Coûts de transaction", "Frais de transaction du portefeuille", "Coûts de négociation"),
        "performance_fee": ("Commission de performance", "Commission de surperformance", "Frais liés à la performance"),
    },
    "nl": {
